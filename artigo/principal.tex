...
\newcommand{\monog}{Teoria dos Grafos e Observabilidade: análise comparativa de arquiteturas \textit{backend} sob estresse de viralização}
...
\newcommand{\AutorC}{Bernardo Jeunon de Alencar}
\newcommand{\funcaoC}{}
\newcommand{\emailC}{}
\newcommand{\cursC}{Orientador do trabalho}
...
\normalsize{\AutorC \footnote{\funcaoC \cursC.}}
\end{flushright}
\thispagestyle{empty}
