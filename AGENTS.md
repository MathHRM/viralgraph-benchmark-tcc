...
Estudar o comportamento das conexões humanas em redes sociais por meio da Teoria dos Grafos, com apoio de uma arquitetura backend de alta performance projetada para ingerir e processar dados relacionais em larga escala.

O tema ainda pode ser refinado durante o desenvolvimento. Antes de alterar seu escopo, problema de pesquisa ou objetivo principal, apresente a proposta e solicite confirmação.
